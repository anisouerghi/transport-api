...
`SUPPORT_TYPE`, `TRANSPORT_SUPPORT`, `REPORT_TYPE`, `REPORT_NATURE`, `PASSENGER`, `STATUS`, `APP_USER`, `ROLE`, `PERMISSION`, `USER_ROLE`, `ROLE_PERMISSION`, `APP_MENU`, `REPORT`, `ATTACHMENT`, `REPORT_HISTORY`, `REPLY`, `AUDIT_LOG`
