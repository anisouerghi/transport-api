        ...
        return args -> {
            ...
            if (reportTypeRepository.count() == 0) {
                ...
                reportTypeRepository.save(ReportType.builder()
                        .code("INCIDENT").label("Incident").description("Incident technique ou sécurité").active(true).build());
                reportTypeRepository.save(ReportType.builder()
                        .code("COMPLAINT").label("Réclamation").description("Réclamation voyageur").active(true).build());
                reportTypeRepository.save(ReportType.builder()
                        .code("SUGGESTION").label("Suggestion").description("Suggestion d'amélioration").active(true).build());
